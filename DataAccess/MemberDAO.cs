...
namespace DataAccess
{
    public class MemberDAO
    {
        ...
        private static List<MemberObject> MemberList = new List<MemberObject>()
        {
            ...
            new MemberObject{MemberID=2, MemberName="Vuong Thi Huong", Email="nguyenkhanhhuyen2003tt@gmail.com",City="Ho Chi Minh", Country="United State", Password="123456789" },
            new MemberObject{MemberID=3, MemberName="Vu Van Trung", Email="trungsp@gmail.com",City="Ho Chi Minh", Country="Viet Nam", Password="12345678911" },
            new MemberObject{MemberID=4, MemberName="Khuat Thanh Hai", Email="haisp@gmail.com",City="Ho Chi Minh", Country="United State", Password="12345678978" },
            new MemberObject{MemberID=5, MemberName="Nguyen Van A", Email="besp@fpt.edu.vn",City="Ha Noi", Country="Viet Nam", Password="12345678" },
            new MemberObject{MemberID=6, MemberName="Nguyen Van Tuan", Email="tuansp@gmail.com",City="Ho Chi Minh", Country="United State", Password="123456789" },
            new MemberObject{MemberID=7, MemberName="Nguyen Thi Thanh Truc", Email="trucsp@gmail.com",City="Ho Chi Minh", Country="Viet Nam", Password="12345678911" },
            new MemberObject{MemberID=8, MemberName="Joey", Email="Joey123@gmail.com",City="Ho Chi Minh", Country="United State", Password="12345678978" },
